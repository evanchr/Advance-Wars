...
public class Foret extends Cases{
	final public static String IDENTIFIANT = "Foret";
	
	public Foret(Coordonnees coordonees, Unites occupe_par) {
	...
	public int getCout(Unites unite, int joueurActif) {
		...
		} else if (unite instanceof Chenilles){
			cout = 2; //cout de 1 pour les Chenilles
		} else {
			cout = 1; //cout de 1 pour toutes les unités sauf Chenilles
		}
		return cout;
	}
}
