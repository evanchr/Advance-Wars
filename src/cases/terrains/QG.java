...
public class QG extends Proprietes{
	final public static String IDENTIFIANT = "QG";
	
	public QG(Coordonnees coordonnees, int appartient, Unites occupe_par) {
		super(coordonnees, appartient, occupe_par, IDENTIFIANT);
	}

	public QG(Coordonnees coordonnees, int appartient) {
	...
	public void affiche(int x, int y) {
		Affichage.dessineImageDansCase(x, y, Chemins.getCheminPropriete(Chemins.FICHIER_QG, appartient)); 
