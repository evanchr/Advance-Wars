 ...
 * @param ligne La ligne sur laquelle afficher le message. Si le nombre est different de 1,2 ou 3, le texte s'affiche au milieu
 */
    public static void afficheTexteDescriptif(String message, int ligne) {
        StdDraw.setPenColor(Config.COULEUR_TEXTE_DESCRIPTIF);
        StdDraw.setFont(Config.POLICE_PAR_DEFAUT);
        switch(ligne) {
        case 1:
        	StdDraw.text(coordXZoneTexte(0.5), coordYZoneTexte(1.0), message);
        	break;
        case 2:
        	StdDraw.text(coordXZoneTexte(0.5), coordYZoneTexte(0.8), message);
        	break;
        case 3:
        	StdDraw.text(coordXZoneTexte(0.5), coordYZoneTexte(0.6), message);
        	break;
        case 4:
        	StdDraw.text(coordXZoneTexte(0.5), coordYZoneTexte(0.4), message);
        	break;
        case 5:
        	StdDraw.text(coordXZoneTexte(0.5), coordYZoneTexte(0.2), message);
        	break;
        case 6:
        	StdDraw.text(coordXZoneTexte(0.5), coordYZoneTexte(0.0), message);
        	break;
        default:
        	StdDraw.text(coordXZoneTexte(0.5), coordYZoneTexte(0.5), message);
        }
    }
