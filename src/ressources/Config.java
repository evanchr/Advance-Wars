...
public class Config {
 	...
 	*/
    public static final char[] TOUCHES_PERTINENTES_CARACTERES = {'t','a','d'};
    ...
    final private static int PIXELS_HAUTEUR_ZONE_TEXTE = 100;
    ...
    final protected static Color POPUP_COULEUR_CADRE = new Color(255, 40, 0);

    /** Police par defaut, celle du texte au-dessus de la carte */
    final protected static Font POLICE_PAR_DEFAUT = new Font(Font.SANS_SERIF, Font.BOLD, 16);

    /** Police du texte de popup */
    final protected static Font POLICE_POPUP = new Font("Arial", Font.BOLD, 14);
